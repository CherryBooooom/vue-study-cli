...
const Content = () =>
    import( /* webpackChunkName: "group-ES6" */ './views/ES6');
const overview = () =>
...
const E = () =>
    import( /* webpackChunkName: "group-ele" */ './views/element');

const V = () =>
    import( /* webpackChunkName: "group-vue" */ './views/vue');
const Life = () =>
    import( /* webpackChunkName: "group-vue" */ './views/vue/Life.vue');
const Base = () =>
    import( /* webpackChunkName: "group-vue" */ './views/vue/Base.vue');
const Slot = () =>
    import( /* webpackChunkName: "group-vue" */ './views/vue/Slot.vue');
